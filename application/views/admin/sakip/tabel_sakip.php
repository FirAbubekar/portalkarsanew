	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Informasi
					<small>Sakip RS Karsa Husada</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
					<li><a href="#">Informasi</a></li>
					<li class="active">Sakip</li>
				</ol>
			</section>
					...
					<div class="col-xs-12">
						...
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">Tabel Sakip</h3>
							</div>
							<!-- /.box-header -->
							<div class="box-body">
								...
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
										<?php $no=1; foreach ($sakip->result() as $row) { ?>
										<tr>
											<td>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Tambah Data SAKIP</h4>
					</div>
					<form enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/informasi/save_sakip'); ?>" role="form">
						...
						<div class="modal-footer">
							<input type="submit" class="btn btn-primary" value="Save SAKIP" style="width: 100%" name="submit">
		...
		<?php foreach ($sakip->result() as $edit) { ?>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title">Edit Data SAKIP</h4>
					</div>
					<form enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/informasi/edit_sakip/'.$edit->id); ?>" role="form">
						<div class="modal-body">
							<div class="box-body">
								<div class="form-group">
									<label for="exampleInputPassword1">Nama File</label>
									<input type="text" name="nama_file" class="form-control" id="exampleInputEmail1"
										value="<?php echo $edit->nama_file?>" placeholder="Masukan Nama File">
								</div>
								<div class="form-group">
									<label for="exampleInputPassword1">Dokumen File</label>
									<input type="file" name="gambar">
                               ...
                               ?></option>
								...
								<?php if($edit->file!=null){?>
										<input type="hidden" name="gambar1" class="form-control" value="<?php echo $edit->file; ?>" placeholder="Masukan Type">
										<div class="form-group">
										<label for="exampleInputPassword1">File</label><br>
										<label><h5><?php echo str_replace('_', ' ',$edit->file);?></h5></label>
									</div>
									<?php } ?>
							</div>
							<!-- /.box-body -->
						...
						<div class="modal-footer">
							<input type="submit" class="btn btn-primary" value="Update SAKIP" style="width: 100%" name="submit">
							<!-- <button type="button" class="btn btn-primary">Save changes</button> -->
						</div>
					</form>
				</div>
		...
		<?php foreach ($sakip->result() as $delete) {?>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>Apakah Anda Yakin Akan Menghapus Data Dengan Judul :
							<b><?php echo $delete->nama_file; ?>&hellip;</b></p>
					</div>
					<div class="modal-footer">
						<!-- <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button> -->
						<a href="<?php echo base_url('admin/informasi/delete_sakip/'.$delete->id); ?>"
							class="btn btn-danger pull-left">Delete SAKIP</a>
