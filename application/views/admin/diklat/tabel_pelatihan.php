	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
                    DIKLAT
					<small>PELATIHAN RS Karsa Husada</small>
				</h1>
				<ol class="breadcrumb">
			...
			<div class="row">
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="info-box">
							...
							<div class="info-box-content">
								<span class="info-box-text">Total PELATIHAN</span>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="info-box">
							...
							<div class="info-box-content">
								<span class="info-box-text">PELATIHAN Aktif</span>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="info-box">
							...
							<div class="info-box-content">
								<span class="info-box-text">PELATIHAN Non Aktif</span>
					...
					<div class="col-xs-12">
						...
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">Tabel Diklat Pelatihan</h3>
								<br><br>
								<center>
								<div class="col-md-12">
									<button type="button" class="btn btn-primary" style="width: 100%;" data-toggle="modal" data-target="#modal-regulasi" >Tambah Pelatihan<span class="fa fa-plus-circle"></span></button>
								</div>
								</center>
								<br>
							</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Tambah Data Konten Diklat Pelatihan</h4>
					</div>
					<form enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/diklat/save'); ?>" role="form">
						...
						<div class="modal-footer">
							<input type="submit" class="btn btn-primary" value="Save Pelatihan" style="width: 100%"
								name="submit">
