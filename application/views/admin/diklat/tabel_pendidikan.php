	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					DIKLAT
					<small>PENDIDIKAN RS Karsa Husada</small>
				</h1>
				<ol class="breadcrumb">
			...
			<div class="row">
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="info-box">
							...
							<div class="info-box-content">
								<span class="info-box-text">Total PENDIDIKAN</span>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="info-box">
							...
							<div class="info-box-content">
								<span class="info-box-text">PENDIDIKAN Aktif</span>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="info-box">
							...
							<div class="info-box-content">
								<span class="info-box-text">PENDIDIKAN Non Aktif</span>
					...
					<div class="col-xs-12">
						...
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">Tabel PENDIDIKAN</h3>
								<br><br>
								<center>
								<div class="col-md-12">
									<button type="button" class="btn btn-primary" style="width: 100%;" data-toggle="modal" data-target="#modal-regulasi" >Tambah Pendidikan <span class="fa fa-plus-circle"></span></button>
								</div>
								</center>
								<br>
							</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Tambah Data Konten Diklat Pendidikan</h4>
					</div>
					<form enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/diklat/save'); ?>" role="form">
						...
						<div class="modal-footer">
							<input type="submit" class="btn btn-primary" value="Save Pendidikan" style="width: 100%"
								name="submit">
