...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
						...
						<div class="box">
							...
							<div class="box-body">
								...
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
										<?php $no=1; foreach ($mutu->result() as $row) { ?>
										<tr>
											<td>
		...
		<div class="modal fade" id="modal-default">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/informasi/save_mutu'); ?>" role="form">
						...
						<div class="modal-footer">
							<input type="submit" class="btn btn-primary" value="Save Mutu" style="width: 100%"
								name="submit">
		...
		<?php foreach ($mutu->result() as $edit) { ?>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title">Edit Data Mutu</h4>
					</div>
					<form enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/informasi/edit_mutu/'.$edit->id); ?>"
						role="form">
						<div class="modal-body">
							<div class="box-body">
								<div class="form-group">
									<label for="exampleInputEmail1">Kategori</label>
									<input type="text" name="type" class="form-control" id="exampleInputEmail1"
										value="<?php echo $edit->type?>" placeholder="Masukan Kategori">
								</div>
								<div class="form-group">
									<label for="exampleInputPassword1">Nama File</label>
									<input type="text" name="nama_file" class="form-control" id="exampleInputEmail1"
						...
						<div class="modal-footer">
							<input type="submit" class="btn btn-primary" value="Update Mutu" style="width: 100%"
								name="submit">
							<!-- <button type="button" class="btn btn-primary">Save changes</button> -->
						</div>
					</form>
		...
		<?php foreach ($mutu->result() as $delete) {?>
			...
			<div class="modal-dialog2">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title">Delete Data Mutu</h4>
					</div>
					<div class="modal-body">
						<p>Apakah Anda Yakin Akan Menghapus Data Mutu Dengan Nama File :
							<b><?php echo $delete->nama_file; ?>&hellip;</b></p>
					</div>
					<div class="modal-footer">
						<!-- <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button> -->
						<a href="<?php echo base_url('admin/informasi/delete_mutu/'.$delete->id); ?>"
							class="btn btn-danger pull-left">Delete Mutu</a>
