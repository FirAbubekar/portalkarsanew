		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Form Tambah Berita</li>
				</ol>
			</section>
			...
			<section class="content">
				...
				<div class="box box-default">
					...
					<div class="box-body">
						<div class="row">
							<div class="col-md-12">
								<form enctype="multipart/form-data" action="<?php echo base_url('admin/informasi/add_berita'); ?>" method="post">
									...
									<div class="form-group">
										...
										<textarea name="link" class="form-control" id="" cols="30" rows="5"></textarea>
									</div>
									<div class="form-group">
										<label>Penulis</label>
					...
					<div class="box-footer">
						* pilih tombol 'Save Berita' Untuk Menambahkan Berita ...
					</div>
					</form>
				</div>
				<!-- /.box -->
