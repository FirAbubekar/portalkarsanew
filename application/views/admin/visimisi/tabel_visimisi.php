...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
					...
					<div class="col-xs-12">
						...
						<div class="box">
							...
							<div class="box-body">
								...
								data-target="#modal-default" style="width: 100%">Tambah Data Profil <span
								...
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
										<?php $no=1; foreach ($profil->result() as $row) { ?>
											<tr>
												<td>
												...
												<td>
													<center>
														...
														data-target="#modal-view-<?php echo $row->id; ?>">View</button>
		...
		<div class="modal fade" id="modal-default">
			...
			<?php foreach ($profil->result() as $edit){ ?>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<form method="post" action="<?php echo base_url('admin/profil/edit_visimisi/'.$edit->id); ?>"
									role="form">
									<div class="modal-body">
										<div class="box-body">
											<div class="form-group">
												...
												value="<?php echo $edit->judul; ?>" id="exampleInputEmail1"
												placeholder="Masukan Judul">
											</div>
											<div class="form-group">
												<label for="exampleInputPassword1">Deskripsi</label>
												<textarea class="texteditor<?php echo $edit->id; ?>" name="deskripsi" rows="10" cols="80">
									...
									<div class="modal-footer">
										<input type="submit" class="btn btn-warning" value="Update Profil" style="width: 100%"
										name="submit">
										<!-- <button type="button" class="btn btn-primary">Save changes</button> -->
									</div>
								</form>
				...
				<?php foreach ($profil->result() as $view){ ?>
					<div class="modal fade" id="modal-view-<?php echo $view->id; ?>">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					...
					<?php foreach ($profil->result() as $delete) {?>
									...
									<div class="modal-header">
										...
										<div class="modal-body">
											...
											<div class="modal-footer">
												...
												<a href="<?php echo base_url('admin/profil/delete_visimisi/'.$delete->id); ?>"
	...
	<?php foreach ($profil->result() as $editor) { ?>
		<script type="text/javascript">
		$('textarea.texteditor<?php echo $editor->id; ?>').ckeditor();
	</script>
<?php } ?>
