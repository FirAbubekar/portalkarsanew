...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Perpustakaan
					<small>Perpustakaan RS Karsa Husada</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-book"></i> Perpustakaan</a></li>
					...
					<div class="col-xs-12">
						...
						<div class="box">
							<div class="box-header">
								...
								style="width: 100%">Tambah Data <span class="fa fa-plus-circle"></span></button>
								<br>
							</div>
							<!-- /.box-header -->
							<div class="box-body">
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
										<?php $no=1; foreach ($perpustakaan->result() as $row) { ?>
											<tr>
												<td>
												...
												<td>
													<center> <?php echo $row->kategori; ?></center>
												</td>
												<td>
													<center> <?php echo date('d-F-Y',strtotime($row->tanggal_upload)); ?></center>
												</td>
												<td>
													<center> <?php echo $row->file; ?></center>
												</td>
												<td>
													<center> <?php 
												 if($row->status==1){
	...
	<div class="modal fade" id="modal-default">
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						...
						<h4 class="modal-title">Tambah Data Dokumen Perpustakaan</h4>
					</div>
					<form enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/perpustakaan/save'); ?>" role="form">
						<div class="modal-body">
							<div class="box-body">
								<div class="form-group">
									<label for="exampleInputEmail1">Nama File</label>
									<input type="text" name="nama_file" class="form-control" id="exampleInputEmail1"
								...
								<div class="form-group">
									...
									<textarea name="link" id="" cols="30" style="width: 100%;" rows="5"></textarea>
								</div>
								<div class="form-group">
						...
						<div class="modal-footer">
							<input type="submit" class="btn btn-primary" value="Save Dokumen Perpustakaan" style="width: 100%" name="submit">
		...
		<?php foreach ($perpustakaan->result() as $edit) { ?>
			<div class="modal fade" id="modal-edit-<?php echo $edit->id; ?>">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span></button>
								<h4 class="modal-title">Edit Data Dokumen Perpustakaan</h4>
							</div>
							<form enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/perpustakaan/edit/'.$edit->id); ?>" role="form">
								<div class="modal-body">
									<div class="box-body">
										<div class="form-group">
											<label for="exampleInputEmail1">Nama File</label>
											<input type="text" name="nama_file" class="form-control" value="<?php echo $edit->nama_file; ?>"
											placeholder="Masukan Nama">
										</div>
										<div class="form-group">
											<label for="exampleInputEmail1">Kategori</label>
											<input type="text" name="kategori" class="form-control" value="<?php echo $edit->kategori; ?>"
											placeholder="Masukan Jabatan">
										</div>
										<div class="form-group">
											<label for="exampleInputEmail1">Link File</label>
											<textarea name="link" style="width: 100%;" id="" cols="30" rows="5"><?php echo $edit->file;?></textarea>
										</div>
										<div class="form-group">
											<label for="exampleInputFile">Aktif</label>
											<select name="status" class="form-control">
									...
									<div class="modal-footer">
										<input type="submit" class="btn btn-primary" value="Update Dokumen Perpustakaan" style="width: 100%" name="submit">
									</div>
								</form>
							</div>
							<!-- /.modal-content -->
				...
				<?php foreach ($perpustakaan->result() as $delete) {?>
						...
						<div class="modal-dialog2">
							<div class="modal-content">
								<div class="modal-header">
									...
									<div class="modal-body">
										<p>Apakah Anda Yakin Akan Menghapus Data Perpustakaan Dengan Nama File : <b><?php echo $delete->nama_file; ?>&hellip;</b></p>
									</div>
									<div class="modal-footer">
										<!-- <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button> -->
										<a href="<?php echo base_url('admin/perpustakaan/delete/'.$delete->id); ?>"
