	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Akun
					<small>Admin RS Karsa Husada</small>
				</h1>
				<ol class="breadcrumb">
					...
					<div class="col-xs-12">
						...
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">Tabel Akun Admin</h3>
							</div>
							<!-- /.box-header -->
							<div class="box-body">
								...
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
										<?php $no=1; foreach ($akun->result() as $row) { ?>
										<tr>
											<td>
												<center> <?php echo $no++; ?></center>
											</td>
											<td> <?php echo $row->username; ?></td>
											<td> <?php if($row->password==null){
                                        echo "Belum Ada";
                                    }
                                    else{
                                        echo "*********";
		...
		<div class="modal fade" id="modal-default">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form method="post" action="<?php echo base_url('admin/akun/save_akun_admin'); ?>" role="form">
						...
						<div class="modal-footer">
							<input type="submit" class="btn btn-primary" value="Save Akun" style="width: 100%"
								name="submit">
		...
		<?php foreach ($akun->result() as $edit) { ?>
		<div class="modal fade" id="modal-edit-<?php echo $edit->id;?>">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form method="post" action="<?php echo base_url('admin/akun/edit_akun_admin/'.$edit->id); ?>"
						role="form">
						<div class="modal-body">
							<div class="box-body">
								<div class="form-group">
									...
									<input type="text" name="username" class="form-control"
										value="<?php echo $edit->username; ?>" id="exampleInputEmail1"
										placeholder="Masukan Username">
								</div>
								<div class="form-group">
									<label for="exampleInputPassword1">Password</label>
									<input type="password" name="password" class="form-control"
										value="<?php echo $edit->password; ?>" id="exampleInputEmail1"
						...
						<div class="modal-footer">
							<input type="submit" class="btn btn-primary" value="Update Akun" style="width: 100%"
								name="submit">
							<!-- <button type="button" class="btn btn-primary">Save changes</button> -->
						</div>
					</form>
		...
		<?php foreach ($akun->result() as $delete) { ?>
		<div class="modal fade" id="modal-delete-<?php echo $delete->id; ?>">
			<div class="modal-dialog2">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>Apakah Anda Yakin Akan Menghapus Data Dengan Username :
							<b><?php echo $delete->username; ?>&hellip;</b>
						</p>
					</div>
					<div class="modal-footer">
						<!-- <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button> -->
						<a href="<?php echo base_url('admin/akun/delete_akun_admin/'.$delete->id); ?>"
							class="btn btn-danger pull-left">Delete Akun</a>
