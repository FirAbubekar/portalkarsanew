...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        PORTAL
        <small>Absensi Karyawan RS Karsa Husada</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Karyawan</a></li>
        <li><a href="#">Absensi</a></li>
        <li class="active">Tabel Absensi</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php $no=1; foreach ($finger as $row) { ?>
                <tr>
                  <td><?php echo $no++; ?></td>
                  <td><?php echo date('d-m-Y', strtotime($row->tanggal)); ?></td>
                  <td><?php echo date('H:i:s', strtotime($row->masuk)); ?></td>
                  <td><?php echo date('H:i:s', strtotime($row->keluar)); ?></td>
                  <td><?php echo $row->status_masuk; ?></td>
                  <td><?php echo $row->cepat_pulang; ?></td>
                </tr>
                <?php } ?>
                </tbody>
                <tfoot>
