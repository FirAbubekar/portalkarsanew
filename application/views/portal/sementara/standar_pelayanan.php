	...
	<div class="wrapper">
		...
		<div class="fun-factor-area bg-img pt-35">
				<div class="container1">
					<div class="ruangan">
						<h3><?php echo "STANDAR PELAYANAN MINIMUM RSUD KARSA HUSADA BATU "; ?></h3>
					</div>
					<div class="describe">
					...
					<div class="d_jam
						...
						<div class="describe">
							...
							<div class="d_ket">
							<p><?php echo ""; ?></p>
                                <embed src="<?php echo base_url('file/zonaintegritas/standar_pelayanan/SPM.pdf'); ?>" style="width:100%;height:700px;" />
							</div>
						</div>
					</div>
					<hr size="2">
